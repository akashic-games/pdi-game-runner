...
export abstract class PlaylogStoreBase implements PlaylogStore {
	abstract storeTick(frame: number, data: Uint8Array, ignorable?: boolean): void;
	abstract getTickList(begin: number, end: number, callback: (error: Error, tickList: TickList) => void, ignorable?: boolean): void;
