...
import { DynamicAMFlowImpl, DynamicAMFlowImplParams } from "../../lib/amflow/DynamicAMFlowImpl";
...
describe("DynamicAMFlowImpl#open()", () => {
	...
	const amflowParams: DynamicAMFlowImplParams = {
		config: {
			amqp: {
				tickExchangePrefix: "",
				eventExchangePrefix: "",
	...
	it("open できる", async () => {
		...
		amflow = new DynamicAMFlowImpl(amflowParams);
